...
function renderReport(companyId, issues, results, backtestModel) {
  ...
  lines.push("");
  lines.push("- [ ] Run the agent end-to-end twice per issue (not just prompt diff) and compare runs-to-completion.");
  ...
  lines.push("");
  lines.push(`*Generated by \`scripts/skill-backtest-quarterly.mjs\` at ${new Date().toISOString()}*`);
