/**
 * PluginEventBus — typed in-process event bus for the Ironworks plugin system.
 *
 * Responsibilities:
...
import type { EventFilter, PluginEvent } from "@ironworksai/plugin-sdk";
import type { PluginEventType } from "@ironworksai/shared";
