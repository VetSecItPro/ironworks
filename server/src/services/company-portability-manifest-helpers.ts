// Manifest construction, YAML parsing/rendering, file-map manipulation, slug
// generation, routine/recurrence logic, project workspace helpers, and the
// network helpers used by the company-portability pipeline. This file holds
// the bulk of the legacy `company-portability-shared.ts` runtime surface that
// did not fit cleanly into types/defaults/skill/path/env domains.
...
} from "./company-portability-defaults.js";
import { dedupeEnvInputs, execFileAsync, readAgentEnvInputs } from "./company-portability-env-helpers.js";
import { ensureMarkdownPath, normalizePortablePath, resolvePortablePath } from "./company-portability-path-helpers.js";
import {
  buildSkillSourceEntry,
  deriveManifestSkillKey,
  readAgentSkillRefs,
} from "./company-portability-skill-helpers.js";
import type { MarkdownDoc, ProjectLike, ResolvedSource, RoutineLike } from "./company-portability-types.js";
