...
import { workspaceRuntimeServices } from "@ironworksai/db";
...
function buildWorkspaceCommandEnv(input: {
  ...
  env.IRONWORKS_WORKSPACE_CWD = input.worktreePath;
  env.IRONWORKS_WORKSPACE_PATH = input.worktreePath;
  env.IRONWORKS_WORKSPACE_WORKTREE_PATH = input.worktreePath;
  env.IRONWORKS_WORKSPACE_BRANCH = input.branchName;
  env.IRONWORKS_WORKSPACE_BASE_CWD = input.base.baseCwd;
  env.IRONWORKS_WORKSPACE_REPO_ROOT = input.repoRoot;
  env.IRONWORKS_WORKSPACE_SOURCE = input.base.source;
  env.IRONWORKS_WORKSPACE_REPO_REF = input.base.repoRef ?? "";
  env.IRONWORKS_WORKSPACE_REPO_URL = input.base.repoUrl ?? "";
  env.IRONWORKS_WORKSPACE_CREATED = input.created ? "true" : "false";
  env.IRONWORKS_PROJECT_ID = input.base.projectId ?? "";
  env.IRONWORKS_PROJECT_WORKSPACE_ID = input.base.workspaceId ?? "";
  env.IRONWORKS_AGENT_ID = input.agent.id;
  env.IRONWORKS_AGENT_NAME = input.agent.name;
  env.IRONWORKS_COMPANY_ID = input.agent.companyId;
  env.IRONWORKS_ISSUE_ID = input.issue?.id ?? "";
  env.IRONWORKS_ISSUE_IDENTIFIER = input.issue?.identifier ?? "";
  env.IRONWORKS_ISSUE_TITLE = input.issue?.title ?? "";
  return env;
}
...
function buildExecutionWorkspaceCleanupEnv(input: {
  ...
  env.IRONWORKS_WORKSPACE_REPO_URL = input.workspace.repoUrl ?? "";
  env.IRONWORKS_WORKSPACE_REPO_REF = input.workspace.baseRef ?? "";
  env.IRONWORKS_PROJECT_ID = input.workspace.projectId ?? "";
  env.IRONWORKS_PROJECT_WORKSPACE_ID = input.workspace.projectWorkspaceId ?? "";
  env.IRONWORKS_ISSUE_ID = input.workspace.sourceIssueId ?? "";
  return env;
}
