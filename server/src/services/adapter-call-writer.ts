 ...
 *      so a future caller that forgets step 1 is still protected.
 *
 ...
 * should already be redacted by the caller.
 */
function sanitizeConfigSnapshot(snapshot: Record<string, unknown> | null | undefined): Record<string, unknown> | null {
