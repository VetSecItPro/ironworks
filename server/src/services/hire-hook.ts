import type { HireApprovedPayload } from "@ironworksai/adapter-utils";
...
const HIRE_APPROVED_MESSAGE =
  "Tell your user that your hire was approved, now they should assign you a task in Ironworks or ask you to create issues.";
