...
import { PLUGIN_STATUSES } from "@ironworksai/shared";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  ...
  },
  {
    ...
    description:
      "Reference plugin that demonstrates the current Ironworks plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
