import { sessionCodec as claudeSessionCodec } from "@ironworksai/adapter-claude-local/server";
import { sessionCodec as codexSessionCodec, isCodexUnknownSessionError } from "@ironworksai/adapter-codex-local/server";
import {
