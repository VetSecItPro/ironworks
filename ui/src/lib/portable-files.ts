...
export function getPortableFileContentType(filePath: string, entry: CompanyPortabilityFileEntry | null | undefined) {
...
export function getPortableFileDataUrl(filePath: string, entry: CompanyPortabilityFileEntry | null | undefined) {
...
export function isPortableImageFile(filePath: string, entry: CompanyPortabilityFileEntry | null | undefined) {
