...
export function CliAuthPage() {
    ...
    return (
      <div className="mx-auto max-w-xl py-10">
        <div className="rounded-lg border border-border bg-card p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            The Ironworks CLI can now finish authentication on the requesting machine.
          </p>
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">Approve Ironworks CLI access</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          A local Ironworks CLI process is requesting board access to this instance.
        </p>
        ...
        <div className="mt-5 space-y-3 text-sm">
          ...
          <div>
            ...
            <div className="text-foreground">{challenge.clientName ?? "ironworksai cli"}</div>
          </div>
          <div>
