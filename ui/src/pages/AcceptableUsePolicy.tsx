...
### 2.8 Misrepresentation of AI Outputs
- Representing AI agent outputs as professional advice (legal, medical, financial, tax, engineering, or otherwise) to third parties without clearly disclosing that the outputs were generated by AI and are not a substitute for qualified human professional advice
- Presenting AI-generated content as the work product of a licensed, certified, or credentialed human professional
- Using AI agent outputs to make automated decisions that materially affect individuals (such as employment, credit, insurance, housing, or legal decisions) without meaningful human review and oversight
- Holding out AI agents as licensed professionals or creating the impression that AI agent outputs carry the authority of professional certification or licensure

## 3. AI Agent Output Requirements

### 3.1 Human Review Required
You must review all AI agent outputs before relying on them, sharing them with third parties, or using them as a basis for decisions. AI outputs are generated by probabilistic machine learning models and may contain errors, inaccuracies, or misleading information.

### 3.2 Disclosure of AI Involvement
When sharing AI agent outputs with third parties, you must clearly disclose that the content was generated or assisted by AI. You may not represent AI-generated content as solely human-created work when such representation would be misleading or deceptive.

### 3.3 High-Risk Activities
For activities in regulated industries or domains where errors could cause significant harm (including but not limited to legal compliance, financial reporting, medical decisions, safety-critical systems, and regulatory filings), you must ensure that qualified human professionals review and approve all AI agent outputs before they are used or relied upon.

### 3.4 No Autonomous High-Stakes Decisions
You may not configure AI agents to make autonomous decisions that materially affect individuals without meaningful human oversight. This includes but is not limited to decisions related to employment, creditworthiness, insurance eligibility, housing, legal rights, or access to essential services.
