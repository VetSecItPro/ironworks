  ...
  return (
    <div className="space-y-10 max-w-4xl">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">Every component, style, and pattern used across Ironworks.</p>
      </div>
      ...
      <Section title="Buttons">
        ...
        <SubSection title="Icon buttons">
          <div className="flex items-center gap-2 flex-wrap">
            <Button variant="ghost" size="icon-xs" aria-label="Search">
              <Search />
            </Button>
      ...
      <Section title="Sheet">
        <Sheet>
          ...
          <SheetContent side="right">
            <SheetHeader>
              <SheetTitle>Mission Properties</SheetTitle>
      ...
      <Section title="Breadcrumb">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbLink href="#">Ironworks App</BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage>Mission List</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </Section>
      ...
      {/* ============================================================ */}
      <Section title="Grouped List (Missions pattern)">
        <div>
