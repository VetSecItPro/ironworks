 ...
 * `useHostContext` from `@ironworksai/plugin-sdk/ui`.  Those are type-only
...
import { type ToastInput, useToast } from "@/context/ToastContext";
 ...
 * registry on `globalThis.__ironworksPluginBridge__`), context propagation
