...
import { useHostContext, usePluginAction, usePluginData, usePluginStream, usePluginToast } from "./bridge.js";
 ...
 *
 * This is placed on `globalThis.__ironworksPluginBridge__` and consumed by
...
declare global {
  ...
  var __ironworksPluginBridge__: PluginBridgeRegistry | undefined;
}
 ...
 * on `globalThis.__ironworksPluginBridge__` so the plugin module loader
...
export function initPluginBridge(react: typeof import("react"), reactDom: typeof import("react-dom")): void {
  globalThis.__ironworksPluginBridge__ = {
    react,
    reactDom,
    sdkUi: {
      usePluginData,
