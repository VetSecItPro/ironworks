                  ...
                  <td className="px-3 py-2.5">
                    <div className="min-w-[180px]">
                      ...
                      {routine.status !== "draft" && (isArchived || routine.status === "paused") && (
                        <div className="mt-1 text-xs text-muted-foreground">{isArchived ? "archived" : "paused"}</div>
                      )}
                    </div>
                  </td>
                  <td className="px-3 py-2.5">
                    ...
                    {routine.lastRun ? (
                      <>
                        ...
                        {routine.lastRun.failureReason ? (
                          <div
                            className="mt-0.5 text-[10px] text-red-500 truncate max-w-[200px]"
                          ...
                          <div
                            className="mt-0.5 text-[10px] text-muted-foreground/80 truncate max-w-[200px]"
                            title={routine.lastRun.linkedIssue.title}
                          >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        onClick={() => onUpdateStatus(routine.id, nextRoutineStatus(routine.status, !enabled))}
                      >
                        <span
                  ...
                  >
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent align="end">
                        <DropdownMenuItem onClick={() => onNavigate(`/routines/${routine.id}`)}>Edit</DropdownMenuItem>
                        <DropdownMenuItem
                        ...
                        <DropdownMenuSeparator />
                        <DropdownMenuItem
                          onClick={() => onUpdateStatus(routine.id, enabled ? "paused" : "active")}
                          disabled={isStatusPending || isArchived}
                        >
                        ...
                        <DropdownMenuItem
                          onClick={() =>
                            onUpdateStatus(routine.id, routine.status === "archived" ? "active" : "archived")
                          }
