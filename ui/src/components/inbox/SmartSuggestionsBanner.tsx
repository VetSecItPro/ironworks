      ...
      <div className="flex items-center gap-2.5 min-w-0">
        ...
        <p className="text-sm">
          <span className="font-medium">
            {autoResolvableCount} item{autoResolvableCount !== 1 ? "s" : ""}
          </span>
          <span className="text-muted-foreground ml-1">
            can be auto-resolved (completed missions, resolved approvals)
          </span>
        </p>
      </div>
      <Button size="sm" variant="outline" className="shrink-0 h-8" onClick={onAutoResolve} disabled={isPending}>
