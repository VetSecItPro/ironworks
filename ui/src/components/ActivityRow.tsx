import { type ActivityEvent, type Agent, deriveProjectUrlKey } from "@ironworksai/shared";
...
const ACTION_VERBS: Record<string, string> = {
  "issue.created": "created mission",
  "issue.updated": "updated mission",
  "issue.checked_out": "checked out mission",
  "issue.released": "released mission",
  "issue.comment_added": "commented on mission",
  "issue.attachment_added": "attached file to mission",
  "issue.attachment_removed": "removed attachment from mission",
  "issue.document_created": "created document for mission",
  "issue.document_updated": "updated document on mission",
  "issue.document_deleted": "deleted document from mission",
  "issue.commented": "commented on mission",
  "issue.deleted": "deleted mission",
...
export const ActivityRow = memo(function ActivityRow({
  ...
  const entityTitle = isCostEvent
    ? costModel
      ? `${costProvider ?? ""}${costProvider && costModel ? " · " : ""}${costModel}`
      : undefined
    ...
    <div className="flex gap-3">
      <p className="flex-1 min-w-0 truncate">
        ...
        {event.action === "issue.updated" &&
          details &&
          (details._previous as Record<string, unknown> | undefined)?.status !== undefined && (
