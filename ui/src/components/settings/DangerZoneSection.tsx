...
export function DangerZoneSection({ selectedCompany, onArchive, isArchiving, archiveError }: DangerZoneSectionProps) {
  return (
      ...
      <div className="space-y-3 rounded-md border border-destructive/40 bg-destructive/5 px-4 py-4">
        ...
        <div className="flex items-center gap-2">
          <Button
            size="sm"
            variant="destructive"
            disabled={isArchiving || selectedCompany.status === "archived"}
            onClick={onArchive}
          >
            {isArchiving
              ? "Archiving..."
