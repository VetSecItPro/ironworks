...
import { Zap, ToggleLeft, ToggleRight, Pencil, Trash2 } from "lucide-react";
import type { AutomationRule, Trigger, Action } from "./automationTypes";
import { TRIGGER_OPTIONS, ACTION_OPTIONS } from "./automationTypes";
