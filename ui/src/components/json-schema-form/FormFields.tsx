...
import type { JsonSchemaNode, FormFieldProps } from "./types";
import { TEXTAREA_THRESHOLD, resolveType, getDefaultForSchema } from "./helpers";
...
export const SecretField = React.memo(({
  ...
  return (
    <FieldWrapper
      ...
      description={
        description ||
        "This secret is stored securely via the Ironworks secret provider."
      }
      required={isRequired}
      error={error}
      disabled={disabled}
