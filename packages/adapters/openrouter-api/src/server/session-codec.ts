/**
 * Session codec for openrouter_api adapter.
 *
 * OpenRouter's API is stateless (R17): conversation state lives entirely in IronWorks.
 * Session params carry the full MessageTurn transcript for replay on each call.
 *
