 ...
 * channel.
 *
 * The Ironworks plugin runtime uses JSON-RPC 2.0 over stdio to communicate
...
export type { PluginLauncherRenderContextSnapshot } from "@ironworksai/shared";

import type { PluginConfigValidationResult, PluginHealthDiagnostics, PluginWebhookInput } from "./define-plugin.js";
import type { PluginEvent, PluginJobContext, PluginWorkspace, ToolResult, ToolRunContext } from "./types.js";
 ...
 * we use strings (UUIDs or monotonic counters) for all Ironworks messages.
 */
...
/**
 * Ironworks plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this Ironworks instance. */
    instanceId: string;
    /** Semver version of the running Ironworks host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
