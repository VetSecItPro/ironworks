...
export {
  ...
  type PatchInstanceNotesSettings,
  type PatchInstanceVaultSnapshotSettings,
  patchInstanceExperimentalSettingsSchema,
  patchInstanceGeneralSettingsSchema,
  patchInstanceNotesSettingsSchema,
  patchVaultSnapshotSettingsSchema,
