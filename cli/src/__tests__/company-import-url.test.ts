...
describe("normalizeGithubImportSource", () => {
  ...
  it("applies --ref to existing GitHub tree URLs without losing the package path", () => {
    expect(
      normalizeGithubImportSource("https://github.com/ironworksai/companies/tree/main/gstack", "release/2026-03-23"),
    ).toBe("https://github.com/ironworksai/companies?ref=release%2F2026-03-23&path=gstack");
  });
});
